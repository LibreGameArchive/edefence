...
/** By hevee, taken from forum post on jmonkeyengine.com*/
public class TextLabel2D {
    ...
    public Quad getQuad(float height){
        ...
        FloatBuffer texCo = ret.getTextureCoords(0).coords;
        ...
        ret.setTextureCoords(new TexCoords(newTC));        //ret.setTextureBuffer(0, newTC);
